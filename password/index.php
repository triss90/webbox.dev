...
<script>
    ...
    function passphraseGen() {
        ...
        var passphrase = '';
        var seperator = '';
        var seperators = '0123456789&&#@';
        for (var i = 0; i < 4; i++) {
            word = words[Math.floor(Math.random()*words.length)];
            word = word.charAt(0).toUpperCase() + word.slice(1);
            seperator = seperators.charAt(Math.floor(Math.random() * seperators.length));
            passphrase += word + seperator;
        }
    ...
    $('#passphrase').change(function(){
        if ($(this).is(':checked')) {
            $('#passwordLength').attr('disabled','disabled').hide();
            $('.passwordLengthLabel').hide();
            $('#symbols').attr('disabled','disabled').hide();
            $('.symbolsLabel').hide();
            $('#numbers').attr('disabled','disabled').hide();
            $('.numbersLabel').hide();
            $('#lowercase').attr('disabled','disabled').hide();
            $('.lowercaseLabel').hide();
            $('#uppercase').attr('disabled','disabled').hide();
            $('.uppercaseLabel').hide();
        } else {
            $('#passwordLength').removeAttr('disabled').show();
            $('.passwordLengthLabel').show();
            $('#symbols').removeAttr('disabled').show();
            $('.symbolsLabel').show();
            $('#numbers').removeAttr('disabled').show();
            $('.numbersLabel').show();
            $('#lowercase').removeAttr('disabled').show();
            $('.lowercaseLabel').show();
            $('#uppercase').removeAttr('disabled').show();
            $('.uppercaseLabel').show();
        }
    });
    ...
    var storedPassphrase = localStorage.getItem('passphrase');

    if (storedPasswordLength != '') {
        $('#passwordLength option[value="'+storedPasswordLength+'"]').attr('selected', 'selected');
    }
    ...
    if (storedPassphrase == 1) {
        $('#passphrase').prop("checked", true);
        $('#passwordLength').attr('disabled','disabled').hide();
        $('.passwordLengthLabel').hide();
        $('#symbols').attr('disabled','disabled').hide();
        $('.symbolsLabel').hide();
        ...
        if ($('#passphrase').is(':checked') == true) {
            ...
            setTimeout(function () {
                ...
                if (save === true) {
                    ...
                    localStorage.setItem('passphrase', 0);
                }
